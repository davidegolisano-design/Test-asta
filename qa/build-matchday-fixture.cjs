...
for(const src of ['../scripts/theme-palettes.js','../scripts/theme-preload.js','./matchday-fixture.js','../scripts/list-filters.js','../scripts/mantra-filter-ui.js','../scripts/theme.js','../scripts/management.js']){const script=document.createElement('script');script.src=src;document.body.append(script)}
