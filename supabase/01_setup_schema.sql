...
create table if not exists public.fanta_rooms (
  ...
  timer_seconds integer not null default 8 check (timer_seconds > 0),
  prep_seconds integer not null default 3 check (prep_seconds > 0),
  sealed_timer_seconds integer not null default 40 check (sealed_timer_seconds > 0),
  sealed_reveal_seconds integer not null default 3 check (sealed_reveal_seconds > 0),
